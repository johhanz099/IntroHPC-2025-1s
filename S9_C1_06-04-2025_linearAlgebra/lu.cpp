...
int main(int argc, char ** argv)
{
    ...
    std::cout << M
                << "\t" << std::fixed << std::setprecision(2) << mean_wtime << "\t" << std::fixed << std::setprecision(2) <<  sigma_wtime
                << "\t" << std::fixed << std::setprecision(1) << mean_ctime << "\t" << std::fixed << std::setprecision(2) <<  sigma_ctime
                << std::endl;
